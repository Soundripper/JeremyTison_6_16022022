const trapFocusLightbox = () => {
  // add all the elements inside modal which you want to make focusable
  const lBfocusableElements = 'button, img';
  ...
  document.addEventListener('keydown', (e) => {
    ...
    } else if (document.activeElement === lBlastFocusableElement) { // if focused has reached to last focusable element then focus first focusable element after pressing tab
